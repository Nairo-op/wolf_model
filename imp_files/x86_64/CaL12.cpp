...
#define ical _ml->template fpfield<2>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"ical"} /* 2 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cal12 /home/amajnas/wolf_model/imp_files/CaL12.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "CaL 1.2 L-type Calcium Channel (Moczydlowski & Latorre 1983)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_cal12. Requires prior call to setdata_cal12 and that the specified mechanism instance still be in existence.", NULL);
  }
...
{ {
   ical = pbar * m * m * ( a * h + ( 1.0 - a ) ) * ghk ( _threadargscomma_ v , cali , calo ) ;
   }
 _current += ical;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/amajnas/wolf_model/imp_files/CaL12.mod";
