 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 nap /home/amajnas/wolf_model/imp_files/NaP.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Persistent Sodium Channel Current (NaP)";
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
 ...
 minf = 1.0 / ( 1.0 + exp ( ( _lv - ( - 52.6 ) ) / ( - 4.6 ) ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv - ( - 48.8 ) ) / 10.0 ) ) ;
   if ( _lv < - 40.0 ) {
   ...
   if ( _lv <= - 100.0 ) {
     ...
     if ( _lv_idx  == 0.0 ) {
       htau = 1500.0 + _lfraction * ( 1583.33 - 1500.0 ) ;
       }
     else if ( _lv_idx  == 1.0 ) {
       htau = 1583.33 + _lfraction * ( 1733.33 - 1583.33 ) ;
       }
     else if ( _lv_idx  == 2.0 ) {
       htau = 1733.33 + _lfraction * ( 2033.33 - 1733.33 ) ;
       }
     else if ( _lv_idx  == 3.0 ) {
       htau = 2033.33 + _lfraction * ( 2100.0 - 2033.33 ) ;
       }
     else if ( _lv_idx  == 4.0 ) {
       htau = 2100.0 + _lfraction * ( 1666.67 - 2100.0 ) ;
       }
     else if ( _lv_idx  == 5.0 ) {
       htau = 1666.67 + _lfraction * ( 1416.67 - 1666.67 ) ;
       }
     else if ( _lv_idx  == 6.0 ) {
       htau = 1416.67 + _lfraction * ( 1166.67 - 1416.67 ) ;
       }
     else if ( _lv_idx  == 7.0 ) {
       htau = 1166.67 + _lfraction * ( 1000.0 - 1166.67 ) ;
       }
     else if ( _lv_idx  == 8.0 ) {
       htau = 1000.0 + _lfraction * ( 900.0 - 1000.0 ) ;
       }
     else if ( _lv_idx  == 9.0 ) {
       htau = 900.0 + _lfraction * ( 833.33 - 900.0 ) ;
       }
     else if ( _lv_idx  == 10.0 ) {
       htau = 833.33 + _lfraction * ( 700.0 - 833.33 ) ;
       }
     }
    return 0; }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/amajnas/wolf_model/imp_files/NaP.mod";
    const char* nmodl_file_text = 
  "TITLE Persistent Sodium Channel Current (NaP)\n"
  "\n"
  "COMMENT\n"
  ...
  "- Kinetics: Activation time-constant mtau is calculated analytically. Inactivation time-constant \n"
  "  htau is obtained using linear interpolation lookup tables in the range of -100 mV to 10 mV.\n"
  "ENDCOMMENT\n"
  "\n"
  "NEURON {\n"
  "    SUFFIX nap\n"
  "    USEION na READ ena WRITE ina\n"
  "    RANGE gbar, ina, minf, hinf, htau, mtau\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "    (mV) = (millivolt)\n"
