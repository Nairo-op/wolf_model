...
#define _tsav _ml->template fpfield<14>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 15);
 	...
 	tau1 = _parm_default[0]; /* 2.82 */
 	tau2 = _parm_default[1]; /* 160 */
 	e = _parm_default[2]; /* 0 */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"_tsav"} /* 14 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NMDA /home/amajnas/wolf_model/imp_files/NMDA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "NMDA Receptor-Mediated Excitatory Synaptic Current with Magnesium Block";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/amajnas/wolf_model/imp_files/NMDA.mod";
