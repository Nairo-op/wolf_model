...
#define htau _ml->template fpfield<4>(_iml)
...
#define ecal _ml->template fpfield<7>(_iml)
#define ecal_columnindex 7
#define ical _ml->template fpfield<8>(_iml)
#define ical_columnindex 8
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"htau"} /* 4 */,
                                       _nrn_mechanism_field<double>{"m"} /* 5 */,
                                       _nrn_mechanism_field<double>{"h"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ecal"} /* 7 */,
                                       _nrn_mechanism_field<double>{"ical"} /* 8 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cat /home/amajnas/wolf_model/imp_files/CaT.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "T-type Calcium Channel Current (CaT)";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/amajnas/wolf_model/imp_files/CaT.mod";
